// Backfill finance transactions: move plaintext description into encryptedDetails and detailsPreview
...
async function run() {
  ...
  // Find transactions where plaintext exists and encrypted is missing
  const filter = {
    where: {
      OR: [
